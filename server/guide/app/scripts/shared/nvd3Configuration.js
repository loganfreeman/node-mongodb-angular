...
angular
    .module( 'themes.nvd3', [] )
    .factory( 'configurationUtils', function() {
        ...
        return {
            ...
            checkElementID: checkElementID,
            initializeMargin: initializeMargin,
            configureLegend: configureLegend,
            initializeLegendMargin: initializeLegendMargin,
