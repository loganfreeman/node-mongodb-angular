    ...
    .factory( 'Auth', function Auth($location, $rootScope, Session, User, Admin, $cookieStore, $http, $q) {
        ...
        return {
            ...
            deleteUser: function(id) {
                return $http.delete( '/devops/user/' + id );
            },

            deleteGroup: function(id) {
                return $http.delete( '/devops/group/' + id );
            },

            deleteInstance: function(id) {
                return $http.delete( '/devops/instance/' + id );
            },

            deleteStack: function(id) {
                return $http.delete( '/devops/stack/' + id );
            },

            deleteDeploy: function(id) {
                return $http.delete( '/devops/deploy/' + id );
            },
